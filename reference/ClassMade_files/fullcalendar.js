...
var defaults = {
	...
	// time formats
	titleFormat: {
		month: 'MMM', // like "September 1986". each language will override this
		week: 'MMM D', // like "Sep 4 1986"
		day: 'MMM D' // like "September 4 1986"
	},
	columnFormat: {
		month: 'ddd', // like "Sat"
...
function EventManager(options) { // assumed to be a calendar
	...
	function _fetchEventSource(source, callback) {
		...
		var start=null;
		var end = null;
		if(rangeStart){start=rangeStart.clone()};
		if(rangeEnd){end = rangeStart.clone();};
		//HJJ
...
/***************** List View *********************/
// PMANIRAHO (oracle - apex) : adding a list view

//add new view and its button
fcViews.agendaList = agendaListView;
defaults.defaultButtonText.agendaList = 'Agenda';//HJJ
